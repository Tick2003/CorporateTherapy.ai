...
import { Play, Pause, Lock, Info, Volume2 } from 'lucide-react';
...
const AudioPage: React.FC = () => {
  ...
  const handlePlayAudio = (id: string) => {
    ...
    if (canPlay) {
      ...
      // Show premium info modal if can't play
  ...
  return (
    <div className="page-container">
      ...
      >
        <h1 className="page-title">Audio Boosts</h1>
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      {audio.isPremium && !user.isPremium && (
                        <div className="bg-accent-100 text-accent-800 px-2 py-0.5 text-xs rounded-full font-medium flex items-center">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {currentlyPlaying !== audio.id && (
                        <div className="flex items-center">
                          <div className="text-xs text-gray-500 mr-2">Preview</div>
        ...
        {showingPremiumInfo && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            ...
            >
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Upgrade to Premium</h3>
              <p className="text-gray-600 mb-4">
                You've reached your free audio plays limit or this is a premium-only audio boost.
              </p>
              <div className="bg-accent-50 p-4 rounded-lg mb-4 border border-accent-100">
                <h4 className="font-medium text-accent-900 mb-2">Premium Benefits:</h4>
